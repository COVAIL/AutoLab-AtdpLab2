...
$PFSENSE = @{
    Id = "PFSENSE_2_4_5";
    Filename = "fw1.vhdx"
    Description = "pfSense CE 2.4.5";
    Architecture = "x64";
    MediaType = "VHD";
    OperatingSystem = "Linux";
    Uri = "file:/C:\DataVolume\Images\Hyper-V\fw1\Virtual Hard Disks\fw1.vhdx";
    #Checksum = '9D1910CF6908734F90A9CE8679C6EF07'
}
 
Register-LabMedia @PFSENSE -Force;
